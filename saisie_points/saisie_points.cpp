...
// saisie_points.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(Csaisie_pointsApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// construction Csaisie_pointsApp

Csaisie_pointsApp::Csaisie_pointsApp()
{
...
// Seul et unique objet Csaisie_pointsApp

Csaisie_pointsApp theApp;


// initialisation de Csaisie_pointsApp

BOOL Csaisie_pointsApp::InitInstance()
{
